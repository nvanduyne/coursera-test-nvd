...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      console.log(chosenCategoryShortName.short_name);//****CHECK FOR A SHORT NAME RETURN---OK
      ...
      console.log(homeHtmlToInsertIntoMainPage); //****CHECK TO SEE IF I AM INPUTING ANYTHING*** --OK SEE SNIPPETS
...
function chooseRandomCategory (categories) {
  ...
  console.log(randomArrayIndex);//***CHECK TO SEE IF WE ACTUALLY GET A RANDOM # ---- OK
